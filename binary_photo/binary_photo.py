...
class New_Image():
    def __init__(self, img: Image, scale=(10,10), font=ROBOTO_REGULAR,
        ...
        background_color: a string describig valid backgroung color options.
                        default is '', which implies white. option: 'tint', 'shade'
        text_color: a string describig valid text color options.
                    default is '', which the pixel color. options: 'tint', 'shade'
        ...
        self.text = text
        self.background_color = self.validate_bg_color(background_color)
        self.text_color = self.validate_text_color(text_color)
        self.tint_factor = self.validate_tint_and_shade(tint_factor)
        self.shade_factor = self.validate_tint_and_shade(shade_factor)
    ...
    def create_pixel_img(self, scale, text, color):
        ...
        font = Font(self.set_text_color(color), self.font, self.font_size)
        #defines the background color of the canvas
        bg_color = self.set_background_color(color)
...
class Binary_Image(New_Image):
    def __init__(self, img, font_size=10, scale=(45,35), **kwargs):
        super().__init__(img, font_size=font_size,scale=scale, **kwargs)
...
if __name__ == '__main__':
    ...
    img = Hex_Image(img, background_color='tint', tint_factor=.9,
                    text_color='shade',shade_factor=.5)
